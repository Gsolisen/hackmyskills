...
- [ ] **FOUND-06**: FSRS v6 scheduling engine wraps `fsrs` library — cards scheduled by due date
- [ ] **FOUND-07**: Review history persisted per card (rating, timestamp, FSRS state fields)
